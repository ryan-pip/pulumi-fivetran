module github.com/ryan-pip/pulumi-fivetran/provider

go 1.25.9

replace github.com/fivetran/terraform-provider-fivetran/shim => ./shim
...
require (
	github.com/fivetran/terraform-provider-fivetran/shim v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/fivetran/terraform-provider-fivetran v1.9.30 // indirect
