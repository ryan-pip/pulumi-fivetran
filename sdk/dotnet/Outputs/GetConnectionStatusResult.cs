...
namespace Pulumi.Fivetran.Outputs
{
    ...
    [OutputType]
    public sealed class GetConnectionStatusResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetConnectionStatusTaskResult> Tasks;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetConnectionStatusWarningResult> Warnings;

        [OutputConstructor]
        private GetConnectionStatusResult(
            ...
            ImmutableArray<Outputs.GetConnectionStatusTaskResult> tasks,

            string updateState,

            ImmutableArray<Outputs.GetConnectionStatusWarningResult> warnings)
        {
