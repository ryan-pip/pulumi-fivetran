...
namespace Pulumi.Fivetran.Inputs
{
    ...
    public sealed class GetGroupConnectionsConnectionStatusInputArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("tasks")]
        private InputList<Inputs.GetGroupConnectionsConnectionStatusTaskInputArgs>? _tasks;

        /// <summary>
        /// The collection of tasks for the connection
        /// </summary>
        public InputList<Inputs.GetGroupConnectionsConnectionStatusTaskInputArgs> Tasks
        {
            get => _tasks ?? (_tasks = new InputList<Inputs.GetGroupConnectionsConnectionStatusTaskInputArgs>());
            set => _tasks = value;
        }
        ...
        [Input("warnings")]
        private InputList<Inputs.GetGroupConnectionsConnectionStatusWarningInputArgs>? _warnings;

        /// <summary>
        /// The collection of warnings for the connection.
        /// </summary>
        public InputList<Inputs.GetGroupConnectionsConnectionStatusWarningInputArgs> Warnings
        {
            get => _warnings ?? (_warnings = new InputList<Inputs.GetGroupConnectionsConnectionStatusWarningInputArgs>());
            set => _warnings = value;
        }

        public GetGroupConnectionsConnectionStatusInputArgs()
        {
        }
        public static new GetGroupConnectionsConnectionStatusInputArgs Empty => new GetGroupConnectionsConnectionStatusInputArgs();
    }
}
