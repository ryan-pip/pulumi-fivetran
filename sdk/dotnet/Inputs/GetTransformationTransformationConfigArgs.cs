...
namespace Pulumi.Fivetran.Inputs
{
    ...
    public sealed class GetTransformationTransformationConfigInputArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.GetTransformationTransformationConfigStepInputArgs>? _steps;
        public InputList<Inputs.GetTransformationTransformationConfigStepInputArgs> Steps
        {
            get => _steps ?? (_steps = new InputList<Inputs.GetTransformationTransformationConfigStepInputArgs>());
            set => _steps = value;
        }
        ...
        public GetTransformationTransformationConfigInputArgs()
        {
        }
        public static new GetTransformationTransformationConfigInputArgs Empty => new GetTransformationTransformationConfigInputArgs();
    }
}
