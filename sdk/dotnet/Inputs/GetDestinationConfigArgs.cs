...
namespace Pulumi.Fivetran.Inputs
{
    ...
    public sealed class GetDestinationConfigInputArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<string> AwsBucketAuthType { get; set; } = null!;
        ...
        public Input<string> AzureStorageAccountAuthType { get; set; } = null!;
        ...
        /// </summary>
        [Input("createExternalVolumes", required: true)]
        public Input<bool> CreateExternalVolumes { get; set; } = null!;
        ...
        public Input<string> DatabricksConnectionType { get; set; } = null!;

        /// <summary>
        /// Field usage depends on `Service` value: 
        /// 	- Service `Snowflake`: The virtual warehouse to use for running queries.
        /// </summary>
        [Input("defaultVirtualWarehouse", required: true)]
        public Input<string> DefaultVirtualWarehouse { get; set; } = null!;
        ...
        /// </summary>
        [Input("disableVacuum", required: true)]
        public Input<bool> DisableVacuum { get; set; } = null!;
        ...
        public Input<bool> EnableExternalStorageForUnstructuredFiles { get; set; } = null!;
        ...
        public Input<bool> EnableSingleTopic { get; set; } = null!;
        ...
        public Input<bool> EnableSuperType { get; set; } = null!;
        ...
        public Input<string> ExternalStageStorageProvider { get; set; } = null!;
        ...
        public Input<string> ExternalStorageCloudProvider { get; set; } = null!;
        ...
        public Input<string> ExternalStorageIntegration { get; set; } = null!;
        ...
        public Input<string> ExternalStorageParentFolderUri { get; set; } = null!;

        /// <summary>
        /// Field usage depends on `Service` value: 
        /// 	- Service `Databricks`: Specifies the external volume path where you want Fivetran to create the unstructured files.
        /// </summary>
        [Input("externalVolumeLocation", required: true)]
        public Input<string> ExternalVolumeLocation { get; set; } = null!;

        [Input("fivetranGlueRoleArn", required: true)]
        public Input<string> FivetranGlueRoleArn { get; set; } = null!;

        [Input("fivetranMskRoleArn", required: true)]
        public Input<string> FivetranMskRoleArn { get; set; } = null!;
        ...
        public Input<string> FivetranRoleArn { get; set; } = null!;
        ...
        public Input<string> GcsProjectId { get; set; } = null!;
        ...
        public Input<Inputs.GetDestinationConfigGcsServiceAccountCredentialsInputArgs> GcsServiceAccountCredentials { get; set; } = null!;
        ...
        public Input<string> GcsServiceAccountCredentialsPath { get; set; } = null!;
        ...
        public Input<bool> IsRedshiftServerless { get; set; } = null!;
        ...
        public Input<string> OnelakeClientId { get; set; } = null!;

        [Input("onelakeClientSecret", required: true)]
        private Input<string>? _onelakeClientSecret;
        ...
        {
            get => _onelakeClientSecret;
            set
            {
                var emptySecret = Output.CreateSecret(0);
                _onelakeClientSecret = Output.Tuple<Input<string>?, int>(value, emptySecret).Apply(t => t.Item1);
            }
        }
        ...
        public Input<string> OnelakeTenantId { get; set; } = null!;
        ...
        public Input<Inputs.GetDestinationConfigPolarisCatalogConfigurationInputArgs> PolarisCatalogConfiguration { get; set; } = null!;
        ...
        /// </summary>
        [Input("s3BucketAuthType", required: true)]
        public Input<string> S3BucketAuthType { get; set; } = null!;
        ...
        public Input<bool> ShouldMaintainTablesInBqms { get; set; } = null!;
        ...
        public Input<bool> ShouldMaintainTablesInDatabricks { get; set; } = null!;
        ...
        public Input<bool> ShouldMaintainTablesInGlue { get; set; } = null!;
        ...
        public Input<bool> ShouldMaintainTablesInOneLake { get; set; } = null!;
        ...
        public Input<bool> ShouldWriteDelta { get; set; } = null!;
        ...
        /// </summary>
        [Input("supportJsonType", required: true)]
        public Input<bool> SupportJsonType { get; set; } = null!;
        ...
        public Input<bool> UseCustomerStaging { get; set; } = null!;
        ...
        public GetDestinationConfigInputArgs()
        {
        }
        public static new GetDestinationConfigInputArgs Empty => new GetDestinationConfigInputArgs();
    }
}
