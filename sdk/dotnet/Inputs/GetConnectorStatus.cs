...
namespace Pulumi.Fivetran.Inputs
{
    ...
    public sealed class GetConnectorStatusArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        private List<Inputs.GetConnectorStatusTaskArgs>? _tasks;

        /// <summary>
        /// The collection of tasks for the connector.
        /// </summary>
        public List<Inputs.GetConnectorStatusTaskArgs> Tasks
        {
            get => _tasks ?? (_tasks = new List<Inputs.GetConnectorStatusTaskArgs>());
            set => _tasks = value;
        }
        ...
        private List<Inputs.GetConnectorStatusWarningArgs>? _warnings;

        /// <summary>
        /// The collection of warnings for the connector.
        /// </summary>
        public List<Inputs.GetConnectorStatusWarningArgs> Warnings
        {
            get => _warnings ?? (_warnings = new List<Inputs.GetConnectorStatusWarningArgs>());
            set => _warnings = value;
        }

        public GetConnectorStatusArgs()
        {
        }
        public static new GetConnectorStatusArgs Empty => new GetConnectorStatusArgs();
    }
}
