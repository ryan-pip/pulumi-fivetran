...
namespace Pulumi.Fivetran.Inputs
{
    ...
    public sealed class ConnectorConfigCustomReportArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<string>? _timeDimensions;

        /// <summary>
        /// Field usage depends on `Service` value: 
        /// 	- Service `Criteo`: Time dimensions to be synced
        /// </summary>
        public InputList<string> TimeDimensions
        {
            get => _timeDimensions ?? (_timeDimensions = new InputList<string>());
        ...
        public static new ConnectorConfigCustomReportArgs Empty => new ConnectorConfigCustomReportArgs();
    }
}
