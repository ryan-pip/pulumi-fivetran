...
namespace Pulumi.Fivetran.Inputs
{
    ...
    public sealed class GetConnectionStatusArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        private List<Inputs.GetConnectionStatusTaskArgs>? _tasks;

        /// <summary>
        /// The collection of tasks for the connection.
        /// </summary>
        public List<Inputs.GetConnectionStatusTaskArgs> Tasks
        {
            get => _tasks ?? (_tasks = new List<Inputs.GetConnectionStatusTaskArgs>());
            set => _tasks = value;
        }
        ...
        private List<Inputs.GetConnectionStatusWarningArgs>? _warnings;

        /// <summary>
        /// The collection of warnings for the connection.
        /// </summary>
        public List<Inputs.GetConnectionStatusWarningArgs> Warnings
        {
            get => _warnings ?? (_warnings = new List<Inputs.GetConnectionStatusWarningArgs>());
            set => _warnings = value;
        }

        public GetConnectionStatusArgs()
        {
        }
        public static new GetConnectionStatusArgs Empty => new GetConnectionStatusArgs();
    }
}
