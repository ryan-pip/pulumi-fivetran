...
namespace Pulumi.Fivetran.Inputs
{
    ...
    public sealed class GetGroupConnectionsConnectionArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        [Input("status")]
        public Inputs.GetGroupConnectionsConnectionStatusArgs? Status { get; set; }
        ...
        public GetGroupConnectionsConnectionArgs()
        {
        }
        public static new GetGroupConnectionsConnectionArgs Empty => new GetGroupConnectionsConnectionArgs();
    }
}
