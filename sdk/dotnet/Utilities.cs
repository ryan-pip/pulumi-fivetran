...
namespace Pulumi.Fivetran
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/ryan-pip";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Fivetran.version.txt");
    ...
    internal sealed class FivetranResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public FivetranResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
