...
func GetUsers(ctx *pulumi.Context, args *GetUsersArgs, opts ...pulumi.InvokeOption) (*GetUsersResult, error) {
	...
	err := ctx.Invoke("fivetran:index/getUsers:getUsers", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetUsersOutput(ctx *pulumi.Context, args GetUsersOutputArgs, opts ...pulumi.InvokeOption) GetUsersResultOutput {
	...
	return ctx.InvokeOutput("fivetran:index/getUsers:getUsers", args, GetUsersResultOutput{}, options).(GetUsersResultOutput)
}
