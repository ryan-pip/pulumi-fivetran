...
// ## Import
//
// 1. To import an existing `UserConnectorMembership` resource into your Terraform state, you need to get `userId` and `connectorId`
...
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := fivetran.NewUserConnectorMembership(ctx, "my_imported_fivetran_user_connector_membership", nil)
//			if err != nil {
//				return err
//			}
//			return nil
