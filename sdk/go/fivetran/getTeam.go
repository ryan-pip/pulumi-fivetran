...
//			_, err := fivetran.GetTeam(ctx, &fivetran.LookupTeamArgs{
//				Id: "team_id",
//			}, nil)
//			if err != nil {
//				return err
...
func LookupTeamOutput(ctx *pulumi.Context, args LookupTeamOutputArgs, opts ...pulumi.InvokeOption) LookupTeamResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupTeamResultOutput, error) {
			...
			return ctx.InvokeOutput("fivetran:index/getTeam:getTeam", args, LookupTeamResultOutput{}, options).(LookupTeamResultOutput), nil
