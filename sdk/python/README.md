...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `fivetran` with the `NAME` of your provider.
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-fivetran
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-fivetran/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-fivetran/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-fivetran_darwin_amd64_v1
│   └── pulumi-resource-fivetran
├── pulumi-fivetran_darwin_arm64
│   └── pulumi-resource-fivetran
├── pulumi-fivetran_linux_amd64_v1
│   └── pulumi-resource-fivetran
├── pulumi-fivetran_linux_arm64
│   └── pulumi-resource-fivetran
├── pulumi-fivetran_windows_amd64_v1
│   └── pulumi-resource-fivetran.exe
└── pulumi-fivetran_windows_arm64
    └── pulumi-resource-fivetran.exe
```
