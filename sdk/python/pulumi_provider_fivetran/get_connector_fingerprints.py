...
def get_connector_fingerprints(fingerprints: Optional[Sequence[Union['GetConnectorFingerprintsFingerprintArgs', 'GetConnectorFingerprintsFingerprintArgsDict']]] = None,
    ...
    :param _builtins.str id: The unique identifier for the resource. Equal to target connection id.
    """
    __args__ = dict()
...
def get_connector_fingerprints_output(fingerprints: pulumi.Input[Optional[Optional[Sequence[Union['GetConnectorFingerprintsFingerprintArgs', 'GetConnectorFingerprintsFingerprintArgsDict']]]]] = None,
