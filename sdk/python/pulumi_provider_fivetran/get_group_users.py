...
def get_group_users(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The unique identifier for the group within the Fivetran system. Data-source will represent a set of users who has membership in this group.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_group_users_output(id: pulumi.Input[Optional[_builtins.str]] = None,
                           users: pulumi.Input[Optional[Optional[Sequence[Union['GetGroupUsersUserArgs', 'GetGroupUsersUserArgsDict']]]]] = None,
