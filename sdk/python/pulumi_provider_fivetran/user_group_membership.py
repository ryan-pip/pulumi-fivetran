...
class UserGroupMembershipArgs:
    def __init__(__self__, *,
                 ...
                 groups: pulumi.Input[Optional[Sequence[pulumi.Input['UserGroupMembershipGroupArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def groups(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['UserGroupMembershipGroupArgs']]]]:
        return pulumi.get(self, "groups")

    @groups.setter
    def groups(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['UserGroupMembershipGroupArgs']]]]):
...
@pulumi.type_token("fivetran:index/userGroupMembership:UserGroupMembership")
class UserGroupMembership(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 groups: pulumi.Input[Optional[Sequence[pulumi.Input[Union['UserGroupMembershipGroupArgs', 'UserGroupMembershipGroupArgsDict']]]]] = None,
                 user_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        1. To import an existing `UserGroupMembership` resource into your Terraform state, you need to get `user_id` and `group_id`
        ...
        my_imported_fivetran_user_group_membership = fivetran.UserGroupMembership("my_imported_fivetran_user_group_membership")
        ```
