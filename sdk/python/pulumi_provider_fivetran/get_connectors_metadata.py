...
def get_connectors_metadata_output(sources: pulumi.Input[Optional[Optional[Sequence[Union['GetConnectorsMetadataSourceArgs', 'GetConnectorsMetadataSourceArgsDict']]]]] = None,
