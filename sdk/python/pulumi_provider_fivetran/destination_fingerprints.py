...
@pulumi.type_token("fivetran:index/destinationFingerprints:DestinationFingerprints")
class DestinationFingerprints(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        my_imported_destination_fingerprints = fivetran.DestinationFingerprints("my_imported_destination_fingerprints")
        ```
