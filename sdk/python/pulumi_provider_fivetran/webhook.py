...
class WebhookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: The webhook type (group, account)
        :param pulumi.Input[_builtins.str] url: Your webhooks URL endpoint for your application
        :param pulumi.Input[_builtins.str] group_id: The group ID
        :param pulumi.Input[_builtins.bool] run_tests: Specifies whether the setup tests should be run
        """
...
@pulumi.type_token("fivetran:index/webhook:Webhook")
class Webhook(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="runTests")
    def run_tests(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Specifies whether the setup tests should be run
        """
        return pulumi.get(self, "run_tests")
