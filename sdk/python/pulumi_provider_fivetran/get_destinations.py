...
def get_destinations_output(destinations: pulumi.Input[Optional[Optional[Sequence[Union['GetDestinationsDestinationArgs', 'GetDestinationsDestinationArgsDict']]]]] = None,
