...
class PrivateLinkArgs:
    ...
    def config_map(self) -> pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]:
        """
        Configuration.
        """
    ...
    @config_map.setter
    def config_map(self, value: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]):
...
class _PrivateLinkState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] state_summary: The state of the private link.
        """
...
class PrivateLink(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="configMap")
    def config_map(self) -> pulumi.Output[Mapping[str, _builtins.str]]:
        """
        Configuration.
        """
        return pulumi.get(self, "config_map")
    ...
    @_builtins.property
    @pulumi.getter(name="stateSummary")
    def state_summary(self) -> pulumi.Output[_builtins.str]:
        """
        The state of the private link.
        """
        return pulumi.get(self, "state_summary")
