...
class _HybridDeploymentAgentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] auth_type: Type of authentification. Possible values `AUTO`,`MANUAL`
        :param pulumi.Input[_builtins.int] authentication_counter: Determines whether re-authentication needs to be performed.
        :param pulumi.Input[_builtins.str] config_json: Base64-encoded content of the config.json file.
        :param pulumi.Input[_builtins.str] display_name: The unique name for the hybrid deployment agent.
        :param pulumi.Input[_builtins.str] docker_compose_yaml: Base64-encoded content of the compose file for the chosen containerization type.
        :param pulumi.Input[_builtins.str] env_type: Environment type. Possible values `DOCKER`,`PODMAN`,`KUBERNETES`,`SNOWPARK`
        :param pulumi.Input[_builtins.str] group_id: The unique identifier for the Group within the Fivetran system.
        :param pulumi.Input[_builtins.str] registered_at: The timestamp of the time the hybrid deployment agent was created in your account.
        :param pulumi.Input[_builtins.str] token: Base64 encoded content of token.
        """
...
class HybridDeploymentAgent(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="authJson")
    def auth_json(self) -> pulumi.Output[_builtins.str]:
        """
        Base64-encoded content of the auth.json file.
        """
        return pulumi.get(self, "auth_json")
    ...
    @_builtins.property
    @pulumi.getter(name="authenticationCounter")
    def authentication_counter(self) -> pulumi.Output[_builtins.int]:
        """
        Determines whether re-authentication needs to be performed.
        """
        return pulumi.get(self, "authentication_counter")
    ...
    @_builtins.property
    @pulumi.getter(name="configJson")
    def config_json(self) -> pulumi.Output[_builtins.str]:
        """
        Base64-encoded content of the config.json file.
        """
        return pulumi.get(self, "config_json")
    ...
    @_builtins.property
    @pulumi.getter(name="dockerComposeYaml")
    def docker_compose_yaml(self) -> pulumi.Output[_builtins.str]:
        """
        Base64-encoded content of the compose file for the chosen containerization type.
        """
        return pulumi.get(self, "docker_compose_yaml")
