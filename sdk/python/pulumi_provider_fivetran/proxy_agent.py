...
class ProxyAgentArgs:
    ...
    def group_region(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @group_region.setter
    def group_region(self, value: pulumi.Input[_builtins.str]):
...
class ProxyAgent(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="clientPrivateKey")
    def client_private_key(self) -> pulumi.Output[_builtins.str]:
        """
        Client private key.
        """
        return pulumi.get(self, "client_private_key")
    ...
    @_builtins.property
    @pulumi.getter(name="groupRegion")
    def group_region(self) -> pulumi.Output[_builtins.str]:
        """
        Data processing location. This is where Fivetran will operate and run computation on data.
        """
        return pulumi.get(self, "group_region")
    ...
    @_builtins.property
    @pulumi.getter(name="registredAt")
    def registred_at(self) -> pulumi.Output[_builtins.str]:
        """
        The timestamp of the time the proxy agent was created in your account.
        """
        return pulumi.get(self, "registred_at")
