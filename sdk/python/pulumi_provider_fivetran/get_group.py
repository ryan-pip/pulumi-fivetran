...
def get_group(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The unique identifier for the group within the Fivetran system.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_group_output(id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('fivetran:index/getGroup:getGroup', __args__, opts=opts, typ=GetGroupResult)
