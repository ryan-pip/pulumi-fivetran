...
def get_group_connectors(connectors: Optional[Sequence[Union['GetGroupConnectorsConnectorArgs', 'GetGroupConnectorsConnectorArgsDict']]] = None,
    ...
    :param _builtins.str schema: Optional filter. When defined, the data source will only contain information for the connector with the specified schema name.
    """
    __args__ = dict()
...
def get_group_connectors_output(connectors: pulumi.Input[Optional[Optional[Sequence[Union['GetGroupConnectorsConnectorArgs', 'GetGroupConnectorsConnectorArgsDict']]]]] = None,
