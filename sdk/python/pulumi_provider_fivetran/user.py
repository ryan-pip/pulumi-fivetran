...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] invited: The field indicates whether the user has been invited to your account.
        :param pulumi.Input[_builtins.str] phone: The phone number of the user.
        :param pulumi.Input[_builtins.str] picture: The user's avatar as a URL link (for example, 'http://mycompany.com/avatars/john_white.png') or base64 data URI (for example, 'data:image/png;base64,aHR0cDovL215Y29tcGFueS5jb20vYXZhdGFycy9qb2huX3doaXRlLnBuZw==')
        :param pulumi.Input[_builtins.str] role: The role that you would like to assign to the user.
        :param pulumi.Input[_builtins.bool] verified: The field indicates whether the user has verified their email address in the account creation process.
        """
...
class _UserState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] given_name: The first name of the user.
        :param pulumi.Input[_builtins.bool] invited: The field indicates whether the user has been invited to your account.
        :param pulumi.Input[_builtins.str] logged_in_at: The last time that the user has logged into their Fivetran account.
        :param pulumi.Input[_builtins.str] phone: The phone number of the user.
        :param pulumi.Input[_builtins.str] picture: The user's avatar as a URL link (for example, 'http://mycompany.com/avatars/john_white.png') or base64 data URI (for example, 'data:image/png;base64,aHR0cDovL215Y29tcGFueS5jb20vYXZhdGFycy9qb2huX3doaXRlLnBuZw==')
        :param pulumi.Input[_builtins.str] role: The role that you would like to assign to the user.
        :param pulumi.Input[_builtins.bool] verified: The field indicates whether the user has verified their email address in the account creation process.
...
@pulumi.type_token("fivetran:index/user:User")
class User(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def invited(self) -> pulumi.Output[_builtins.bool]:
        """
        The field indicates whether the user has been invited to your account.
        """
        return pulumi.get(self, "invited")
    ...
    @_builtins.property
    @pulumi.getter(name="loggedInAt")
    def logged_in_at(self) -> pulumi.Output[_builtins.str]:
        """
        The last time that the user has logged into their Fivetran account.
        """
        return pulumi.get(self, "logged_in_at")
    ...
    @_builtins.property
    @pulumi.getter
    def picture(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The user's avatar as a URL link (for example, 'http://mycompany.com/avatars/john_white.png') or base64 data URI (for example, 'data:image/png;base64,aHR0cDovL215Y29tcGFueS5jb20vYXZhdGFycy9qb2huX3doaXRlLnBuZw==')
        """
        return pulumi.get(self, "picture")
