...
class GetPrivateLinksResult:
    ...
    @property
    @pulumi.getter
    def items(self) -> Optional[Sequence['outputs.GetPrivateLinksItemResult']]:
...
def get_private_links(items: Optional[Sequence[Union['GetPrivateLinksItemArgs', 'GetPrivateLinksItemArgsDict']]] = None,
