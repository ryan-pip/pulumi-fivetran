...
def get_group_connections(connections: Optional[Sequence[Union['GetGroupConnectionsConnectionArgs', 'GetGroupConnectionsConnectionArgsDict']]] = None,
    ...
    :param _builtins.str schema: Optional filter. When defined, the data source will only contain information for the connection with the specified schema name.
    """
    __args__ = dict()
