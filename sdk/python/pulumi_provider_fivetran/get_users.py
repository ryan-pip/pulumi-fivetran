...
def get_users(id: Optional[_builtins.str] = None,
...
def get_users_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('fivetran:index/getUsers:getUsers', __args__, opts=opts, typ=GetUsersResult)
