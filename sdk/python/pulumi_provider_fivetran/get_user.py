...
class GetUserResult:
    ...
    @_builtins.property
    @pulumi.getter
    def invited(self) -> _builtins.bool:
        """
    ...
    def logged_in_at(self) -> _builtins.str:
        """
...
def get_user(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The unique identifier for the user within the Fivetran system.
    """
    __args__ = dict()
    __args__['id'] = id
